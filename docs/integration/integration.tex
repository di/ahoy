...
\_get\_rx\_power with appropriate source \texttt{Node} and destination \texttt{Node} IDs. A valid number should be
passed as the third argument for the source power. }{The function should return a number equivalent to what is expected
by the equation in 4.2.3.1 of the AHOY Design Document.}
