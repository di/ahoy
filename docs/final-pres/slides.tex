...
\frame
{
    ...
    \includegraphics[scale=.28]{images/drexel.pdf} & \includegraphics[scale=.33]{images/nrl.png} & \includegraphics[scale=.125]{images/acin.pdf} & \includegraphics[scale=.125]{images/cvut.png} \\
    \end{tabular}
    \end{center}
