...
\operations{
    \operation{add\_sensor(name, sensor)}{\texttt{name}: Name of the sensor.  \texttt{sensor}: Sensor instance}{None}{Adds a sensor and associates it with a name.}
    \operation{get\_sensor(name)}{\texttt{name}: Name of the sensor}{Sensor instance}{Gets a sensor by name.}
