...
\attributes{
    \attribute{\_entities}{Dictionary}{Maps entity ids to entities}
    \attribute{\_networks}{Dictionary}{Maps network names to the network}
...
\operations{
    ...
    \operation{get\_entities()}{None}{Dictionary}{Returns the dictionary of entities}
    ...
    \operation{get\_networks()}{None}{Dictionary}{Returns the dictionary of networks}
...
\attributes{
    \attribute{MAX\_DISTANCE}{const float}{Maximum distance the entity can move in kilometers}
...
\operations{
    \operation{set\_rcs(rcs)}{\texttt{rcs}: TODO}{None}{TODO}
    \operation{get\_rcs()}{None}{TODO}{TODO}
...
\attributes{
    \attribute{\_interfaces}{Dictionary[name]=Interface}{A dictionary mapping the name of an network interface to the interface itself. }
    \attribute{\_agents}{Dictionary[id]=Agent}{A dictionary mapping agent ids to the agents themselves.}
}
