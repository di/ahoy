...
\begin{figure}
    ...
    \tikzstyle{distnode} = [draw, rectangle, rounded corners, fill=MidnightBlue!10, minimum width=3.2cm]
    \tikzstyle{extnode} = [draw, rectangle, rounded corners, fill=red!10, minimum width=3.2cm]
    ...
    \begin{tikzpicture}
        ...
        \path (e1.west) edge[<->, >=triangle 90] node {} (tcp);
        \path (e3.west) edge[<->, >=triangle 90] node {} (tcp);
    \end{tikzpicture}
