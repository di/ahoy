...
\begin{figure}
    ...
    \begin{tikzpicture}[node distance=.1cm]
        ...
        \node [component, below right of=Event, yshift=-0cm] (LinkEvent) {\textbf{LinkEvent}};
        \node [component, below right of=Event, yshift=-1cm] (StartupEvent) {\textbf{StartupEvent}};
        \node [component, below right of=Event, yshift=-2cm] (AckStartupEvent) {\textbf{AckStartupEvent}};
        \node [component, below right of=Event, yshift=-3cm] (MoveEvent) {\textbf{EntityMoveEvent}};
        \node [component, below right of=Event, yshift=-4cm] (StopSimulationEvent) {\textbf{StopSimulationEvent}};
        \node [component, below right of=Event, yshift=-5cm] (StartSimulationEvent) {\textbf{StartSimulationEvent}};
        \node [component, below right of=Event, yshift=-6cm] (CommunicationSendEvent) {\textbf{CommunicationSendEvent}};
        \node [component, below right of=Event, yshift=-7cm] (CommunicationRecvEvent) {\textbf{CommunicationRecvEvent}};

        \draw[out=270, in=180, <-, >=open triangle 45]
            (Event) to (LinkEvent)
            (Event) to (MoveEvent)
