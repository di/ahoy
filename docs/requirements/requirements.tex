...
\hypersetup{
    ...
    linkcolor=blue,
    urlcolor=blue,
    pdftitle={STAGE Software Requirements Specification V4},
...
\begin{figure}[hb]
  ...
  \caption[A visual representation of mobile nodes on the world map.]%
  {The Visualizer displays mobile nodes (represented by the helicopters) interacting on the world map.  The terrain (the city below) can
